...
- SHA-256: `188D877671CD8D4331E129DFE29A8469C95647D13CBBC78289A24E8A11E5E388`
- Interne Grundlage: 544 JVM-Tests, 0 Fehler/Errors; vollständige sichtbare Übergangsmatrix in `UI_TRANSITION_AUDIT.md` plus Pocket-Pickup-Ressourcenprüfung. Die Installation erfolgt ausschließlich **in place**;
...
| 2 | Inventar und Ruheansicht abwarten. | HD01, PC02–PC04, PC20 | Eine abgesetzte Karte „Sicherungsstatus“. Hauptzeile zeigt ausschließlich den aktuellen Stand: laufend, vorbereitet, aktuelle Synchronisation fertig, Telefon fertig/SSD ausstehend oder Synchronisation fertig. Bei aktuell unvollständiger Liste: keine Übertragung. Ein offener lokaler Integritäts- oder Zuordnungsnachweis wird als **Synchronisation offen** erklärt, nicht als laufende Prüfung. Historische Prüffälle erscheinen nur als zweiter Hinweis und widersprechen einer neuen Sicherung nie. Kein alter technischer Vierzeiler und kein dauerhaft sichtbarer Fortschrittsbalken ohne echte Arbeit. Wiederholte unveränderte Statuspublikationen dürfen Raster, Kopfzeilen oder Filter nicht sichtbar verschieben/flackern lassen. | Leeres/unvollständiges Inventar wird fälschlich vertraut, Hauptstatus widerspricht aktuellem Ergebnis, offene Arbeit wird als laufend behauptet, Anzeige bleibt nach Abschluss aktiv, oder unveränderte Publikationen lassen das Raster flackern = FAIL. |
| 3 | Einen neuen, sicheren Testclip aufnehmen; App öffnen, keine Download-Taste drücken. | HD01, PC05–PC08, PC18 | Service startet genau einen Download. Die Statuskarte und genau die aktive Videokachel zeigen Vorbereitung → **Synchronisation aufs Telefon** mit fortschreitendem Prozentbalken → Integritätsabschluss. Falls der Pocket vor dem ersten Byte kurz 404/500 antwortet, zeigen beide stattdessen sichtbar „Kamera antwortet noch – Übertragung wird erneut versucht“ und einen indeterminierten Balken; innerhalb der begrenzten Versuche folgt echter Fortschritt oder ein dauerhafter Review-Zustand. Nach Abschluss verschwindet der Livebalken und die Kachel zeigt den dauerhaften lokalen Beleg; andere Kacheln bleiben unverändert. Danach keine falsche Quellen-/Redundanz-/Löschfreigabe. | Doppelwriter/falscher Abschluss/stehender oder nachlaufender Videofortschritt, oder ein Retry ohne sichtbaren aktuellen Zustand = FAIL. |
...
| 7 | **Nur bei SSD-Topologie:** Pocket trennen, einmal leeren SSD-Ordner autorisieren, SSD entfernen/neu verbinden, App neu starten. | HD03, HD05 | Vorheriger Grant und Zielpfad werden sicher wiedererkannt; Catch-up ohne Pocket/Picker. Während echter SSD-Kopie zeigt die Karte **SSD-Synchronisation läuft** mit aktuellem Zähler/Prozent. Danach aktualisiert sie ohne App-Neustart auf den neuen dauerhaften Status. | Neuer Picker nötig, Schreiben bei fehlendem Grant oder Überschreiben, hängender SSD-Status = FAIL; Topologie fehlt = HARDWARE_DEFERRED. |
