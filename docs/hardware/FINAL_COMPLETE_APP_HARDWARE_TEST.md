...
| 7 | **Nur bei SSD-Topologie:** Pocket trennen, einmal leeren SSD-Ordner autorisieren, SSD entfernen/neu verbinden, App neu starten. | HD03, HD05 | Vorheriger Grant und Zielpfad werden sicher wiedererkannt; Catch-up ohne Pocket/Picker. Nach echter SSD-Kopie aktualisiert die sichtbare Karte ohne App-Neustart auf den neuen dauerhaften Status. | Neuer Picker nötig, Schreiben bei fehlendem Grant oder Überschreiben = FAIL; Topologie fehlt = HARDWARE_DEFERRED. |
